          ...
          <div class="row">
              <div class="col-12">
                  <nav class="main-nav">
                      <!-- ***** Logo Start ***** -->
                      <a href="/" class="logo">
                          <img src="{{asset('storage/images/templatemo-eduwell.png')}}" alt="EduWell Template">
                      </a>
                      <!-- ***** Logo End ***** -->
                      <!-- ***** Menu Start ***** -->
                      <ul class="nav">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="right-image">
            <img src="{{asset('storage/images/banner-right-image.png')}}" alt="">
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="owl-service-item owl-carousel">
            <div class="item">
              <div class="service-item">
                <div class="icon">
                  <img src="{{asset('storage/images/service-icon-01.png')}}" alt="">
                </div>
                <h4>Useful Tricks</h4>
            ...
            <div class="item">
              <div class="service-item">
                <div class="icon">
                  <img src="{{asset('storage/images/service-icon-02.png')}}" alt="">
                </div>
            ...
            <div class="item">
              <div class="service-item">
                <div class="icon">
                  <img src="{{asset('storage/images/service-icon-03.png')}}" alt="">
                </div>
                <h4>Ready Target</h4>
            ...
            <div class="item">
              <div class="service-item">
                <div class="icon">
                  <img src="{{asset('storage/images/service-icon-04.png')}}" alt="">
                </div>
                <h4>Technology</h4>
                ...
                <div class="col-lg-9">
                  <ul class="nacc">
                    <li class="active">
                      <div>
                        <div class="left-image">
                          <img src="{{asset('storage/images/courses-01.jpg')}}" alt="">
                    ...
                    <li>
                      <div>
                        <div class="left-image">
                          <img src="{{asset('storage/images/courses-02.jpg')}}" alt="">
                    ...
                    <li>
                      <div>
                        <div class="left-image">
                          <img src="{{asset('storage/images/courses-03.jpg')}}" alt="">
                    ...
                    <li>
                      <div>
                        <div class="left-image">
                          <img src="{{asset('storage/images/courses-04.jpg')}}" alt="">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-5 offset-lg-1">
          <div class="left-image">
            <img src="{{asset('storage/images/cta-left-image.png')}}" alt="">
          </div>
        </div>
          ...
          <div class="owl-testimonials owl-carousel" style="position: relative; z-index: 5;">
            <div class="item">
              <p>“just think about TemplateMo if you need free CSS templates for your website”</p>
                ...
                <img src="{{asset('storage/images/quote.png')}}" alt="">
            </div>
            <div class="item">
